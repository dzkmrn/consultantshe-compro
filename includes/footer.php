    ...
    <footer class="footer">
        <div class="container footer__inner">
            <div class="footer__brand">
                <img src="<?= ASSETS_URL ?>images/logo.webp" alt="<?= htmlspecialchars(SITE_NAME) ?>" class="footer__logo">
    ...
    ?>
    <a href="<?= $wa_url ?>" class="whatsapp-fab" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
